...
const Aboutus = () => {
  return (
        ...
        <div className='flex justify-center flex-col lg:flex-row md:flex-row w-full pt-10 '>
            <div className='w-full flex px-4 mb-10 lg:px-0 lg:mb-0 lg:w-[35%] md:w-1/2'>
                <img src={image} alt="photome" className='mx-auto max-w-full' />
            </div>
            <div className='w-full flex flex-col px-4 lg:mx-5 md:mx-5 md:px-2 lg:px-5 lg:w-[42%] md:w-1/2'>
